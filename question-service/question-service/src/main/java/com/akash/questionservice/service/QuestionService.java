...
public class QuestionService {
    ...
    public ResponseEntity<List<Integer>> getQuestionForQuiz(String catagoryName, Integer numQuestion) {
        List<Integer> questions = questionDao.findRandomQuestionsByCategory(catagoryName, numQuestion);
