...
import com.akash.quizservice.feignclient.QuizInterface;
...
public class QuizService {
    ...
    public ResponseEntity<List<QuestionWrapper>> getQuizQuestions(Integer id) {
            ...
            ResponseEntity<List<QuestionWrapper>>questionWrappers = quizInterface.getQuestionFromId(questionsIds);
            return questionWrappers;
    }

    public ResponseEntity<Integer> calculateResult(Integer id, List<Response> responses) {
            ResponseEntity<Integer> scores = quizInterface.getScore(responses);
            return scores;
    }
}
